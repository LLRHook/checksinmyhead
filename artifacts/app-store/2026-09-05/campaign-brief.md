# Billington App Store preview brief

Use freshly captured current Flutter UI on a local iOS simulator, with fictional Lisbon weekend data. Primary brand colors come from mobile/lib/config/theme.dart: teal #328983, dark teal #2A736E, warm neutral #D9B38C, with cream and forest for the campaign background. Avoid unrelated cobalt/lime. Lead with the result of a completed split, not setup forms.
